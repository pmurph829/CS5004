...
public class QuestionTest {
  ...
  public void test_answerShortAnswerInvalid() {
    String message = "Am I having a great day, you ask? Well, the answer depends entirely upon " +
  ...
  public void test_toString(){
    ...
    assertEquals("Question: How is your day going?\n\n"
            + "Answer: I am having a great day.\n\n", shortAnswer.toString());
    assertEquals("Question: I am having a great day.\n\n"
